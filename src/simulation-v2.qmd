...
```{r label = "Generating Data", cached = TRUE}
...
prop_histogram_all = list(
    demystifing1 = plot_prop_histogram(data.all$demystifing1$prop, "Demystifying 1"),
    demystifing2 = plot_prop_histogram(data.all$demystifing2$prop, "Demystifying 2"),
    framework1 = plot_prop_histogram(data.all$framework1$prop, "Framework 1"),
    framework2 = plot_prop_histogram(data.all$framework2$prop, "Framework 2"),
    framework3 = plot_prop_histogram(data.all$framework3$prop, "Framework 3"),
    stable_eff = plot_prop_histogram(data.all$stable_eff$prop, "Stable and Efficient"),
    br = plot_prop_histogram(data.all$br$prop, "Bias-Reduced"),
    improved_DR1 = plot_prop_histogram(data.all$improved_DR1$prop, "Improved DR 1 (Demystifying 3)"),
    improved_DR2 = plot_prop_histogram(data.all$improved_DR2$prop, "Improved DR 2 (Demystifying 4)")
)
```

```{r label = "Fitted Models"}
fitted_model.all = list(
    demystifing1 = do.call(Fitted.model1$new, data.all$demystifing1$data),
    demystifing2 = do.call(Fitted.model2$new, data.all$demystifing2$data),
    framework1 = do.call(Fitted.model3$new, data.all$framework1$data),
    framework2 = do.call(Fitted.model4$new, data.all$framework2$data),
    framework3 = do.call(Fitted.model5$new, data.all$framework3$data),
    stable_eff = do.call(Fitted.model6$new, data.all$stable_eff$data),
    br = do.call(Fitted.model7$new, data.all$br$data),
    improved_DR1 = do.call(Fitted.model8$new, data.all$improved_DR1$data),
    improved_DR2 = do.call(Fitted.model9$new, data.all$improved_DR2$data)
)
```
...
```{r label = "Both Models are Correct"}
params_11.all = list(
    demystifing1 = obtain_params_list(fitted_model.all$demystifing1, prop_model = TRUE, impute_model = TRUE),
    demystifing2 = obtain_params_list(fitted_model.all$demystifing2, prop_model = TRUE, impute_model = TRUE),
    framework1 = obtain_params_list(fitted_model.all$framework1, prop_model = TRUE, impute_model = TRUE),
    framework2 = obtain_params_list(fitted_model.all$framework2, prop_model = TRUE, impute_model = TRUE),
    framework3 = obtain_params_list(fitted_model.all$framework3, prop_model = TRUE, impute_model = TRUE, prop.specify = TRUE, prop.correct = TRUE),
    stable_eff = obtain_params_list(fitted_model.all$stable_eff, prop_model = TRUE, impute_model = TRUE),
    br = obtain_params_list(fitted_model.all$br, prop_model = TRUE, impute_model = TRUE),
    improved_DR1 = obtain_params_list(fitted_model.all$improved_DR1, prop_model = TRUE, impute_model = TRUE),
    improved_DR2 = obtain_params_list(fitted_model.all$improved_DR2, prop_model = TRUE, impute_model = TRUE)
)
```

## Missing Model is Incorrect

```{r label = "Missing Model is Incorrect"}
params_01.all = list(
)
```
...
```{r label = "Imputation Model is Incorrect"}
params_10.all = list(
...
```{r label = "Both Models are Incorrect"}
params_00.all = list(
